# EBV_EUR_Genesis_SuppTable.R


## RUN THE BASH SCRIPT: qsub EBV_EUR_Genesis_SuppTable.sh
...
write.csv(dfall,file=paste0(file.path,'EBV_EUR_Genesis_5e6.csv'),row.names=FALSE )

## write this file for supplemental material 
write.csv(dfall[dfall$Score.pval<=5e-8, ],file=paste0(file.path,'EBV_EUR_Genesis_5e8.csv'),row.names=FALSE )
