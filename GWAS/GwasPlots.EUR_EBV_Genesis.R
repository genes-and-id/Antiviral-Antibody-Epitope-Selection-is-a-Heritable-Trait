# GwasPlots.EUR_EBV_Genesis.R

## TO RUN: qsub GwasPlots.EUR_EBV_Genesis.sh

## RESULTS FROM GWAS.EBV.EUR_Genesis_2019-07-19.R
...
## Get ID for df 
ID <- gsub('/dcl01/leased/pduggal/UK_TwinData/Deep_Immune_HumanOmni5-4v1-1/CIDR/for_priya_aspera/gwas/Assoc/2019_07_19/EBV_PHENOS/Imputed/EUR_Genesis/|.assoc','',file)
...
# setwd for the plots
setwd('/dcl01/leased/pduggal/UK_TwinData/Deep_Immune_HumanOmni5-4v1-1/CIDR/for_priya_aspera/gwas/Assoc/2019_07_19/EBV_PHENOS/Imputed/EUR_Genesis/Plots')

## Manhattan plot
png(filename=paste0('Manhattan.EBV_EUR_',ID,'.png'),width=1800,height=800,units="px",pointsize=12,bg="white")
manhattan(temp, chr = "chr", bp = "pos", p = "Score.pval",
			snp = "variant.id", main=paste('EBV-EUR',ID), 
...
## Q-Q plot
png(filename=paste0('qqplot_EBV_EUR_',ID,'.png'),width=1800,height=800,units="px",pointsize=12,bg="white" )
qq(temp$Score.pval,main=paste('EBV-EUR',ID,'Lambda=',lambda),
cex.lab=1.5,cex.axis=1.5,cex.main=1.5,cex.sub=1.5 )
dev.off()
